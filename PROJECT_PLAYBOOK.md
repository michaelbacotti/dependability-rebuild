...
2. **Draft note** using `signalhouse/templates/daily_template.md`:
...
2. **Draft report** using `signalhouse/templates/weekly_template.md`:
...
2. **Draft** using `signalhouse/templates/evergreen_template.md`:
